  ...
  return (
    <div className="min-h-screen bg-background pb-20">
            ...
            <div key={product.id} className="group relative flex flex-col h-full bg-card rounded-2xl overflow-hidden border border-border shadow-sm hover:shadow-2xl transition-all duration-500">
              ...
              <Link href={`/shop/${product.id}`} className="relative aspect-[4/5] overflow-hidden bg-secondary">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                  <Badge className="bg-white/90 backdrop-blur text-[10px] font-black uppercase tracking-widest text-primary border-none shadow-sm py-1">
                    Verified Batch
                  </Badge>
                  {product.stock < 10 && (
              ...
              <div className="p-6 flex-1 flex flex-col space-y-4">
                ...
                <div className="pt-4 border-t border-border flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="bg-stone-900 hover:bg-primary text-white rounded-xl px-5 h-12 font-bold shadow-lg transition-all active:scale-95"
                  >
                    Add to Cart
                  </Button>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 mt-12 pb-24">
        <div className="bg-stone-900 rounded-[2.5rem] p-8 lg:p-16 flex flex-col lg:flex-row items-center gap-12 overflow-hidden relative">
          ...
          <div className="flex-1 space-y-6 relative z-10 text-center lg:text-left">
            <Badge className="bg-white/10 text-white border-white/20">Artisan Spotlight</Badge>
            ...
            <Button className="bg-white text-stone-900 hover:bg-primary hover:text-white h-14 px-8 rounded-xl font-bold text-lg">
              Our Mission
            </Button>
          </div>
