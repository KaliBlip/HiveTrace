...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#fafaf9] text-[#1c1917] font-sans">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-xl border-b border-stone-200 z-[100]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10">
            <Link href="#mission" className="text-sm font-bold uppercase tracking-widest text-stone-500 hover:text-primary transition-colors">
              Our Mission
            </Link>
            <Link href="#technology" className="text-sm font-bold uppercase tracking-widest text-stone-500 hover:text-primary transition-colors">
              Technology
            </Link>
            <Link href="/shop" className="text-sm font-bold uppercase tracking-widest text-stone-500 hover:text-primary transition-colors">
              Marketplace
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 py-24 lg:py-32">
          <div className="max-w-3xl space-y-10">
            <div className="space-y-6">
              ...
              <h1 className="text-7xl lg:text-9xl font-black tracking-[0.05em] leading-[0.85] uppercase italic">
                PURE. <br />
                <span className="text-primary not-italic tracking-tight">VERIFIED.</span> <br />
                TRACEABLE.
              </h1>
              <p className="text-xl text-stone-400 font-medium max-w-xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <Link href="/auth/register?role=producer">
                <Button size="lg" variant="outline" className="h-16 px-10 text-lg font-bold rounded-2xl border-2 border-stone-700 hover:bg-stone-800 transition-all">
                  Producer Portal
                </Button>
              </Link>
            </div>

            <div className="flex items-center gap-12 pt-12 border-t border-stone-800">
              <div className="space-y-1">
                <p className="text-4xl font-black tracking-tighter">12K+</p>
                <p className="text-xs font-black uppercase tracking-widest text-stone-500">Verified Batches</p>
              </div>
              <div className="space-y-1">
                <p className="text-4xl font-black tracking-tighter">98%</p>
                <p className="text-xs font-black uppercase tracking-widest text-stone-500">Trust Score</p>
              </div>
              <div className="space-y-1">
                <p className="text-4xl font-black tracking-tighter">500+</p>
                <p className="text-xs font-black uppercase tracking-widest text-stone-500">Artisan Beekeepers</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-12">
              <div className="space-y-6">
                ...
                <h2 className="text-6xl lg:text-7xl font-black tracking-tighter leading-none italic uppercase">
                  ELIMINATING <br />
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
            <div className="space-y-10 order-2 lg:order-1 text-center lg:text-left">
              <div className="space-y-6">
                ...
                <h2 className="text-5xl lg:text-8xl font-black leading-[0.9] tracking-tighter uppercase italic">
                  BEE THE <br />
      ...
      <section className="py-32 px-4 bg-white">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { name: "Acacia Reserve", price: "₦15,000", img: "https://images.unsplash.com/photo-1471943311424-646960669fba?q=80&w=1000" },
              { name: "Wildflower Gold", price: "₦12,500", img: "https://images.unsplash.com/photo-1587334206516-951e046a5ef0?q=80&w=1000" },
              { name: "Plateau Premium", price: "₦18,000", img: "https://images.unsplash.com/photo-1558583055-d7ac00b1adca?q=80&w=1000" }
            ].map((product, i) => (
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Link href="/auth/login">
                <Button size="lg" variant="outline" className="h-16 px-12 text-xl font-bold rounded-2xl border-2 border-stone-700">
                  Member Portal
                </Button>
              </Link>
            </div>
