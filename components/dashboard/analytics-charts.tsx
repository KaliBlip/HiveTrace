...
type ScanDatum = Record<string, unknown>;
type BatchPerformanceDatum = Record<string, unknown>;

export function AnalyticsCharts(props: {
  scanData: ScanDatum[];
  batchPerformance: BatchPerformanceDatum[];
}) {
  const { scanData, batchPerformance } = props;
